"""Caustic: predict NMR backbone chemical shifts from 3D protein structure.
...
as a lightweight ONNX Runtime package (~50 MB install) with calibrated
uncertainty estimates and NEF / NMR-STAR / CSV / JSON output.
